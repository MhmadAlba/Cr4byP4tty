...
system('cls');
system('title Admin  Finder (Garuda Security Hacker)');
system "color 0a";
print"\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\t>   Admin  Finder (Garuda Security Hacker)  >\n";
print "\t>     Edited By Cr4byP4tty From Garuda SECURITY Hacker      >\n";
print "\t>  Greetz: Yukinoshita47 | _Tuan2fay_      >\n";
print "\t>           Snooze       | OetrageousEngkus         >\n";
print "\t> more >> blog.garudasecurityhacker.org    >\n";
print "\t>                                         >\n";
print "\t>         Ngentot lo pepek :v       >\n";
print "\t>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n";
print "\n";
